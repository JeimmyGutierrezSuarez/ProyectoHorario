...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('fichas', function (Blueprint $table) {
            ...
            $table->string('codigoPrograma'); //Se define campo para el codigo del programa que aparece en el diseño curricular
            ...
            $table->string('proyectoProductivo'); //Se define campo para el proyecto de la ficha
            $table->timestamps();
