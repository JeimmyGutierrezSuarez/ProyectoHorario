...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('diseno_curriculars', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('idRed'); //Columna que almacena el id de la red correspondiente
            $table->unsignedBigInteger('idArea'); //Columna que almacena el id de el area correspondiente
