...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('horarios', function (Blueprint $table) {
            ...
            $table->string('numeroFicha'); //Columna que almacena el id ficha - llave foranea  de la tabla ficha
           ...
           #$table->string('versionProrama'); //Columna que almacena la version del programa
            ...
            $table->unsignedBigInteger('codigoPrograma'); //columna que almacena codigo del programa
            ...
            $table->unsignedBigInteger('cedula'); //Columna que almacena la cedula del instructor - llave foranea de la tabla instructor
            ...
            $table->foreign('idSede')->references('idSedes')->on('sedes')->onDelete('cascade');
            $table->foreign('idAmbiente')->references('idAmbientes')->on('ambientes')->onDelete('cascade');
            $table->foreign('idCompetencia')->references('idCompetencia')->on('competencias')->onDelete('cascade');
            $table->foreign('codigoPrograma')->references('codigoPrograma')->on('diseno_curricular')->onDelete('cascade');
